...
1. __Clone the repository__: ``` git clone https://github.com/jG-codeR13/Chat-ON.git```
...
2. Chat Page
- Chatroom ![](https://github.com/jG-codeR13/Chat-ON/blob/main/img/Chat-2.png)

- Private Text ![](https://github.com/jG-codeR13/Chat-ON/blob/main/img/Chat-1.png)
